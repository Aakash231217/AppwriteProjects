...
export class Service{
    ...
    async createPost({title,slug, content,featuredImage,
        ...
        try{
            ...
            console.log("Appwrite service ::Crearte Post:: error", error);
        }
    }
    ...
    async getPost(slug){
        try{
            ...
            console.log("Appwrite Error:: Couldn't fetch posts",error)
            return false;
        }
    }
    async getPosts(queries = [Query.equal("status","active")]){
          try{
           return await this.databases.listDocuments(
            ...
            console.log("Appwrite serve::Couldn't fetch",error);
            return false;
          }
    }
